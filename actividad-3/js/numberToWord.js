...
function load() {
 var $btnConvert = document.getElementById('js-btnConvert');
...
function showWord() {
  var $inputNumber = document.getElementById('js-inputNumber'); //Obtener el input
  var $word = document.getElementById('js-word'); //Obtener el elemento p de html con el id word
  var $boxWord = document.getElementById('js-boxWord'); //Obtener el article con el id boxWord
